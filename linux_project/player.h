...
struct Player {
    ...
    void update_pos(const Chunk &chunk, const GLfloat* look, double time_delta);

    void update_pos_onground(const Chunk &chunk, const GLfloat* look, double time_delta);
    void update_pos_falling(const Chunk &chunk, const GLfloat* look, double time_delta);
    void update_pos_flying(const Chunk &chunk, const GLfloat* look, double time_delta);
